        ...
        <div class="container">
                <div class="row align-items-center">
                        <div class="hero-content col-lg-6 col-md-6 col-sm-12 text-right-lg text-right-md text-center-sm">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.Dolorem autem debitis nam? Suscipit dolor incidunt saepe quos distinctio ab, reprehenderit dignissimos! Harum.</p>
                                <a class="btn btn-fancy btn-fancy-primary"href="">Get Started</a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                                <form class="form"action="">
                                        ...
                                        <button class="btn btn-fancy btn-fancy-primary"type="submit">Submit</button>
                                </form>
                        </div>
                </div>
        </div>
        ...
        <div class="container">
                <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 margin-auto text-center-lg text-center-md text-center-sm">
                                ...
                                <a class="btn btn-fancy btn-fancy-primary"href="#">Contact Now</a>
                        </div>
                </div>
        </div>
</section>
